...
logo='''
\033[1;94m ┈┈┈┈╱▔▔▔▔▔▔╲┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈╱▔▔▔▔╲┈┈┈┈
\033[1;94m ┈┈┈▕▕▔S❤️A▔▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕B4 M4▏▏┈┈┈
\033[1;94m ┈┈┈▕▕▂╱💀╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
\033[1;94m ┈┈┈┈╲┊┊__┊┊╱┈┈┈┈\033[1;94mShabirBaloch.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈
\033[1;96m ┈┈┈┈▕'╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
...
\033[1;91m☞ Auther     : SA~WH-HACKER
\033[1;92m☞ Facebook   : https://www.facebook.com/sumon.whitehacker
\033[1;95m☞ YouTube    : https://youtube.com/channel/UCfzlbH3kM0DHI0K3k9rWW9Q
...
def login():
	...
	try:
		...
		if 'access_token' in z:
		    ...
		    os.system('xdg-open https://youtube.com/channel/UCfzlbH3kM0DHI0K3k9rWW9Q')
		    menu()
		else:
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update SA Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' SA~WH-HACKER FB ID')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/SA~WH-HACKER')
	    ...
	    psb('Instagram @white_hacker_sumon✓')
	    psb('WellCome To SA~WH-HACKER')
	    psb('Congratulations SA Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ SumonAsha✓')
	    psb('🔓Password ☆ SumonAsha✓')
	    psb('Subscrib My Youtube Channel TRIBAL CHIEF✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/SA~WH-HACKER && python2 SA.py')
	elif bm =='3':
	    os.system('xdg-open https://www.facebook.com/sumon.whitehacker')
	    menu()
	elif bm =='4':
...
def pb():
	...
	print(S+50*'-')
	print
	print(S+'Process has been completed CP ID Open After few hours ')
	print(Y+'Total '+G+'OK'+S+'/'+P+'CP'+S+' = '+G+str(len(oks))+S+'/'+R+str(len(cps)))
	print(S+'SumonAsha')     
	print
	raw_input(R + 'Back')
	os.system('python2 SA.py')
